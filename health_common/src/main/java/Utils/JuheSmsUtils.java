...
public class JuheSmsUtils {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="ec4a197c2d886f48acfd6f9229bfc368";
...
public static void main(String[] args) {
    sengYZMSms("17321094198","1234");
}

    //2.发送短信
    public static void sengYZMSms( String mobile,String code){
        String result =null;
        String url ="http://v.juhe.cn/sms/send";//请求接口地址
        Map params = new HashMap();//请求参数
        params.put("mobile",mobile);//接收短信的手机号码
        params.put("tpl_id","174812");//短信模板ID，请参考个人中心短信模板设置
        ...
        try {
            result =net(url, params, "GET");
//            JSONObject object = JSONObject.fromObject(result);
            /*JSON.parseObject(result);将字符串转json对象
            * 对象转字符串:toJsonString*/
